<div class="table-responsive">
    <table class="table" id='confirmed-table' style='width: 100%'>
        <?php $results  = mysqli_query($con, "SELECT * from words_contribution  where word_status = 'Confirmed'"); ?>
...
contribution = $('#confirmed-table').DataTable({
        order: [
            [4, 'desc']
        ],
        dom: 'Bfrtip',
...
$('#confirmed-table').on('click', '.btnConfirm', function() {
    $tr = $(this).closest('tr');
...
$('#contribution-table').on('click', '.btnReject', function() {
    $tr = $(this).closest('tr');
