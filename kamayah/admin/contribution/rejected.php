<div class="table-responsive">
    <table class="table" id='rejected-table' style='width: 100%'>
        <?php $results  = mysqli_query($con, "SELECT * from words_contribution  where word_status = 'Rejected'"); ?>
...
contribution = $('#rejected-table').DataTable({
        order: [
            [4, 'desc']
        ],
        dom: 'Bfrtip',
...
$('#rejected-table').on('click', '.btnConfirm', function() {
    $tr = $(this).closest('tr');
