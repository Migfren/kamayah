<div class="table-responsive">
    <table class="table" id='contribution-table' style='width: 100%'>
        <?php $results  = mysqli_query($con, "SELECT * from words_contribution"); ?>
...
contribution = $('#contribution-table').DataTable({
        order: [
            [4, 'desc']
        ],
        dom: 'Bfrtip',
...
$('#contribution-table').on('click', '.btnConfirm', function() {
    $tr = $(this).closest('tr');
