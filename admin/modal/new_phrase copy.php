<?php
    ...
    $_SESSION['nonce_edit'] = substr(str_shuffle(MD5(microtime())), 0, 10);
?>
...
<!-- edit -->
<script>
window.nonce_edit = "<?php echo $_SESSION['nonce_edit']; ?>"
...
const edit_uploadAudio = a => {
    ...
    b.append("nonce_edit", window.nonce_edit);
    b.append("payload_edit", a);
    ...
    // console.log(phraseedit_id);

    $.ajax({
        url: "modal/edit_audio.php",
        method: "POST",
        phrase_id: phrase_id,
        body: b,
